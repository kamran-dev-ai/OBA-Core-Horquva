...
| ------- | ------------------------------ | ---------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ | ----------- |
| T01     | Application Launch             | Castor application initializes and displays the UI                                             | Chrome opens, but Castor fails during initialization with `Unsupported operation: Platform._operatingSystem` | **FAIL**    |
...
Chrome opens successfully, but the Castor application does not initialize.
